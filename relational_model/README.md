...
|     endeudamiento (antes se llamaba endeudamientoPDE)    |     DECIMAL(12,2)    |     51831754.13              |     Importe total de endeudamiento que corresponde a préstamos y   emisiones.    |     http://vocab.ciudadesabiertas.es/def/economia/deuda-publica-financiera#endeudamiento                     |
...
|     tipo_fijo (antes se llamaba tasa_fija)    |     DECIMAL(12,2)    |                                                                                                                                      |     Porcentaje de interés fijo de un instrumento de financiación                                                                                                                                            |     http://vocab.ciudadesabiertas.es/def/economia/deuda-publica-financiera#tipoFijo                             |
...
|     anio (antes se llamaba anio_fiscal y era un atributo del   vocabulario de Presupuesto)    |     VARCHAR(4)       |     2017                                                                                                                              |     Año al cual corresponde la carga financiera.                                                                                                                                                 |     http://vocab.ciudadesabiertas.es/def/economia/deuda-publica-financiera#anio                                      |
